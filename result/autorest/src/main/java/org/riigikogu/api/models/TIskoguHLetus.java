...
public class TIskoguHLetus {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withVotingNumber(Integer votingNumber) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withType(KlassifikaatoriVRtus type) {
        this.type = type;
        return this;
    }
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withDescription(String description) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withStartDateTime(DateTime startDateTime) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withEndDateTime(DateTime endDateTime) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withPresent(Integer present) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withAbsent(Integer absent) {
        this.absent = absent;
        return this;
    }
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withInFavor(Integer inFavor) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withAgainst(Integer against) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withNeutral(Integer neutral) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withAbstained(Integer abstained) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withRelatedDraft(EelnUToimikBaas relatedDraft) {
     ...
     * @return the TIskoguHLetus object itself.
     */
    public TIskoguHLetus withRelatedDocument(DokumentBaas relatedDocument) {
