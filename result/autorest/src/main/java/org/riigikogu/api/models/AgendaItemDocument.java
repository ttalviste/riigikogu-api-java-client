 ...
 */
public class AgendaItemDocument {
    /**
     * The _links property.
     */
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withReference(String reference) {
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withDocumentType(String documentType) {
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withCreated(DateTime created) {
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withMembership(Integer membership) {
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withVolume(BaseVolume volume) {
        this.volume = volume;
        return this;
    }
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withRelatedDocuments(List<BaseDocument> relatedDocuments) {
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withRelatedVolumes(List<BaseVolume> relatedVolumes) {
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withFiles(List<FileMetadata> files) {
        this.files = files;
        return this;
    }
     ...
     * @return the AgendaItemDocument object itself.
     */
    public AgendaItemDocument withOrder(Integer order) {
        this.order = order;
        return this;
    }
