...
/**
 * Dokument (päevakorrapunkt).
 */
public class DokumentPEvakorrapunkt {
    /**
     * The _links property.
     */
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withReference(String reference) {
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withDocumentType(String documentType) {
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withCreated(DateTime created) {
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withMembership(Integer membership) {
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withVolume(ToimikBaas volume) {
        this.volume = volume;
        return this;
    }
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withRelatedDocuments(List<DokumentBaas> relatedDocuments) {
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withRelatedVolumes(List<ToimikBaas> relatedVolumes) {
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withFiles(List<Fail> files) {
        this.files = files;
        return this;
    }
     ...
     * @return the DokumentPEvakorrapunkt object itself.
     */
    public DokumentPEvakorrapunkt withOrder(Integer order) {
        this.order = order;
        return this;
    }
