...
public class Fail {
     ...
     * @return the Fail object itself.
     */
    public Fail with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the Fail object itself.
     */
    public Fail withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the Fail object itself.
     */
    public Fail withFileName(String fileName) {
     ...
     * @return the Fail object itself.
     */
    public Fail withFileExtension(String fileExtension) {
