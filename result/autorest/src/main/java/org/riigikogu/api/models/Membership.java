...
public class Membership {
     ...
     * @return the Membership object itself.
     */
    public Membership with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the Membership object itself.
     */
    public Membership withNumber(Integer number) {
        this.number = number;
        return this;
    }
     ...
     * @return the Membership object itself.
     */
    public Membership withStartDate(LocalDate startDate) {
     ...
     * @return the Membership object itself.
     */
    public Membership withEndDate(LocalDate endDate) {
     ...
     * @return the Membership object itself.
     */
    public Membership withSessions(List<Session> sessions) {
