 ...
 */
public class PagedResourcesOfVolumes {
    /**
     * The _embedded property.
     */
    @JsonProperty(value = "_embedded")
    private List<Volumes> _embedded;
     ...
     * @return the PagedResourcesOfVolumes object itself.
     */
    public PagedResourcesOfVolumes with_embedded(List<Volumes> _embedded) {
     ...
     * @return the PagedResourcesOfVolumes object itself.
     */
    public PagedResourcesOfVolumes with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the PagedResourcesOfVolumes object itself.
     */
    public PagedResourcesOfVolumes withPage(PageMetadata page) {
        this.page = page;
        return this;
    }
