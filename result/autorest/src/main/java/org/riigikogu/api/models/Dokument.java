...
public class Dokument {
     ...
     * @return the Dokument object itself.
     */
    public Dokument with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the Dokument object itself.
     */
    public Dokument withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the Dokument object itself.
     */
    public Dokument withReference(String reference) {
     ...
     * @return the Dokument object itself.
     */
    public Dokument withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the Dokument object itself.
     */
    public Dokument withDocumentType(String documentType) {
     ...
     * @return the Dokument object itself.
     */
    public Dokument withCreated(DateTime created) {
     ...
     * @return the Dokument object itself.
     */
    public Dokument withMembership(Integer membership) {
     ...
     * @return the Dokument object itself.
     */
    public Dokument withVolume(ToimikBaas volume) {
        this.volume = volume;
        return this;
    }
     ...
     * @return the Dokument object itself.
     */
    public Dokument withRelatedDocuments(List<DokumentBaas> relatedDocuments) {
     ...
     * @return the Dokument object itself.
     */
    public Dokument withRelatedVolumes(List<ToimikBaas> relatedVolumes) {
     ...
     * @return the Dokument object itself.
     */
    public Dokument withFiles(List<Fail> files) {
        this.files = files;
        return this;
    }
