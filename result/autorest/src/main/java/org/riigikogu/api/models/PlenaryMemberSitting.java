 ...
 */
public class PlenaryMemberSitting {
    /**
     * The _links property.
     */
     ...
     * @return the PlenaryMemberSitting object itself.
     */
    public PlenaryMemberSitting with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the PlenaryMemberSitting object itself.
     */
    public PlenaryMemberSitting withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the PlenaryMemberSitting object itself.
     */
    public PlenaryMemberSitting withType(ClassifierValue type) {
        this.type = type;
        return this;
    }
     ...
     * @return the PlenaryMemberSitting object itself.
     */
    public PlenaryMemberSitting withDescription(String description) {
     ...
     * @return the PlenaryMemberSitting object itself.
     */
    public PlenaryMemberSitting withStartDateTime(DateTime startDateTime) {
     ...
     * @return the PlenaryMemberSitting object itself.
     */
    public PlenaryMemberSitting withDecision(ClassifierValue decision) {
     ...
     * @return the PlenaryMemberSitting object itself.
     */
    public PlenaryMemberSitting withRelatedDraft(DraftVolume relatedDraft) {
