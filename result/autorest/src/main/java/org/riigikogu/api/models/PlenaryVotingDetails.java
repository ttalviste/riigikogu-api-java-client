 ...
 */
public class PlenaryVotingDetails {
    /**
     * The _links property.
     */
    ...
    private BaseVolume sitting;

    /**
     * Istungi juhataja.
     */
    @JsonProperty(value = "chairman")
    private BaseUser chairman;

    /**
     * Hääletajad.
     */
    @JsonProperty(value = "voters")
    private List<PlenaryVoter> voters;
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withVotingNumber(Integer votingNumber) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withType(ClassifierValue type) {
        this.type = type;
        return this;
    }
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withDescription(String description) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withStartDateTime(DateTime startDateTime) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withEndDateTime(DateTime endDateTime) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withPresent(Integer present) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withAbsent(Integer absent) {
        this.absent = absent;
        return this;
    }
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withInFavor(Integer inFavor) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withAgainst(Integer against) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withNeutral(Integer neutral) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withAbstained(Integer abstained) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withRelatedDraft(DraftVolume relatedDraft) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withRelatedDocument(BaseDocument relatedDocument) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withSitting(BaseVolume sitting) {
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withChairman(BaseUser chairman) {
     ...
     */
    public List<PlenaryVoter> voters() {
        return this.voters;
    }
     ...
     * @return the PlenaryVotingDetails object itself.
     */
    public PlenaryVotingDetails withVoters(List<PlenaryVoter> voters) {
        this.voters = voters;
        return this;
    }
