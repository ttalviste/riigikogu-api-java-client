...
public class Kasutaja {
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withMembership(KasutajagrupiLiige membership) {
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withFirstName(String firstName) {
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withLastName(String lastName) {
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withFullName(String fullName) {
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withActive(Boolean active) {
        this.active = active;
        return this;
    }
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withEmail(String email) {
        this.email = email;
        return this;
    }
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withPhone(String phone) {
        this.phone = phone;
        return this;
    }
     ...
     * @return the Kasutaja object itself.
     */
    public Kasutaja withPhoto(Fail photo) {
        this.photo = photo;
        return this;
    }
