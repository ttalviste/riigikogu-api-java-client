 ...
 */
public class CollectiveAddress {
    /**
     * The _links property.
     */
    ...
    private BaseUserGroup responsibleCommittee;

    /**
     * Staatused / menetluskäik.
     */
    @JsonProperty(value = "statuses")
    private List<CollectiveAddressStatus> statuses;
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withReference(String reference) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withDocumentType(String documentType) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withCreated(DateTime created) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withMembership(Integer membership) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withVolume(BaseVolume volume) {
        this.volume = volume;
        return this;
    }
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withRelatedDocuments(List<BaseDocument> relatedDocuments) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withRelatedVolumes(List<BaseVolume> relatedVolumes) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withFiles(List<FileMetadata> files) {
        this.files = files;
        return this;
    }
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withSender(String sender) {
        this.sender = sender;
        return this;
    }
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withSenderReference(String senderReference) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withSubmittingDate(LocalDate submittingDate) {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withComplianceDeadline(LocalDate complianceDeadline) {
     ...
     */
    public BaseUserGroup responsibleCommittee() {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withResponsibleCommittee(BaseUserGroup responsibleCommittee) {
     ...
     */
    public List<CollectiveAddressStatus> statuses() {
     ...
     * @return the CollectiveAddress object itself.
     */
    public CollectiveAddress withStatuses(List<CollectiveAddressStatus> statuses) {
