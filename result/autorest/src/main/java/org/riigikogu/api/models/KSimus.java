...
public class KSimus {
     ...
     * @return the KSimus object itself.
     */
    public KSimus with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     * @return the KSimus object itself.
     */
    public KSimus withUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @return the KSimus object itself.
     */
    public KSimus withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the KSimus object itself.
     */
    public KSimus withSubmittedDate(LocalDate submittedDate) {
