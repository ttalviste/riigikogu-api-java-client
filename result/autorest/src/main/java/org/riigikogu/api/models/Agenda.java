...
public class Agenda {
    ...
    private List<PlenarySitting> sittings;
     ...
     * @return the Agenda object itself.
     */
    public Agenda with_links(List<Link> _links) {
        this._links = _links;
        return this;
    }
     ...
     */
    public List<PlenarySitting> sittings() {
     ...
     * @return the Agenda object itself.
     */
    public Agenda withSittings(List<PlenarySitting> sittings) {
     ...
     * @return the Agenda object itself.
     */
    public Agenda withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the Agenda object itself.
     */
    public Agenda withWeekEndDate(LocalDate weekEndDate) {
     ...
     * @return the Agenda object itself.
     */
    public Agenda withWeekStartDate(LocalDate weekStartDate) {
